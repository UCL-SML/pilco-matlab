...
\begin{abstract}%   <- trailing '%' for backward compatibility of .sty file
  ...
  previously in
  \cite{Deisenroth2011c,Deisenroth2011b,Deisenroth2014}. The
  high-level steps of the \textsc{pilco} algorithm, which are also
  implemented in this software package, are the following: Learn a
  Gaussian process (GP) model of the system dynamics, perform
  deterministic approximate inference for policy evaluation, update
  the policy parameters using exact gradient information, apply the
  learned controller to the system.
  % benefit
